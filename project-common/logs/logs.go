...
type LogConfig struct {
	DebugFileName string `json:"debugFileName"` //debug级别
	InfoFileName  string `json:"infoFileName"`  //info级别
	WarnFileName  string `json:"warnFileName"`  //warn级别
	MaxSize       int    `json:"maxsize"`       //日志最大容量
	MaxAge        int    `json:"max_age"`       //日志过期时间
	MaxBackups    int    `json:"max_backups"`   //日志备份数量
}
